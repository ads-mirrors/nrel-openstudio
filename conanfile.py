...
class OpenStudioBuildRecipe(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires("pugixml/1.14")  # 5a39f82651eba3e7d6197903a3202e21
        self.requires(
            "libxml2/[<2.12.0]"
        ...
        self.requires("jsoncpp/1.9.6")  # 536d080aa154e5853332339bf576747c
        self.requires("fmt/11.1.4")  # 811e918ca4b4e0b9ddd6d5a2883efa82
        self.requires("sqlite3/3.49.1")  # 010911927ce1889b5cf824f45e7cd3d2
        ...
        self.requires("geographiclib/2.4")  # 76536a9315a003ef3511919310b2fe37
        self.requires("swig/4.3.0")  # Pending https://github.com/conan-io/conan-center-index/pull/19058
        self.requires("tinygltf/2.9.0")  # c8b2aca9505e86312bb42aa0e1c639ec
        self.requires("cli11/2.5.0")  # 8ccdf14fb1ad53532d498c16ae580b4b
