...
TEST_F(ModelFixture, PipeAdiabaticSteam_PipeAdiabaticSteam) {
  ::testing::FLAGS_gtest_death_test_style = "threadsafe";

  ASSERT_EXIT(
    {
      Model m;
      PipeAdiabaticSteam pipe(m);
...
TEST_F(ModelFixture, PipeAdiabaticSteam_addToNode) {
  Model m;
  PipeAdiabaticSteam testObject(m);
  ...
  PipeAdiabaticSteam testObject2(m);
  ...
  auto testObjectClone = testObject.clone(m).cast<PipeAdiabaticSteam>();
  supplyOutletNode = plantLoop.supplyOutletNode();
