...
namespace model {
  ...
  namespace detail {
    ...
    DefaultSurfaceConstructions_Impl::DefaultSurfaceConstructions_Impl(const openstudio::detail::WorkspaceObject_Impl& other, Model_Impl* model,
                                                                       bool keepHandle)
      : ResourceObject_Impl(other, model, keepHandle) {
      OS_ASSERT(other.iddObject().type() == DefaultSurfaceConstructions::iddObjectType());
    }

    DefaultSurfaceConstructions_Impl::DefaultSurfaceConstructions_Impl(const DefaultSurfaceConstructions_Impl& other, Model_Impl* model,
                                                                       bool keepHandle)
      : ResourceObject_Impl(other, model, keepHandle) {}
  ...
  DefaultSurfaceConstructions::DefaultSurfaceConstructions(const Model& model) : ResourceObject(DefaultSurfaceConstructions::iddObjectType(), model) {
