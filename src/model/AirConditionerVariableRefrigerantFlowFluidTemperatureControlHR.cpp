...
namespace model {
  ...
  namespace detail {
    ...
    std::vector<ScheduleTypeKey>
      ...
      if (std::find(fieldIndices.cbegin(), fieldIndices.cend(),
          ...
          != fieldIndices.cend()) {
        result.emplace_back("AirConditionerVariableRefrigerantFlowFluidTemperatureControlHR", "Availability Schedule");
      }
      return result;
    }
    ...
    std::vector<FuelType> AirConditionerVariableRefrigerantFlowFluidTemperatureControlHR_Impl::coolingFuelTypes() const {
      return {FuelType::Electricity};
    }

    std::vector<FuelType> AirConditionerVariableRefrigerantFlowFluidTemperatureControlHR_Impl::heatingFuelTypes() const {
      return {FuelType::Electricity};
    }

    std::vector<AppGFuelType> AirConditionerVariableRefrigerantFlowFluidTemperatureControlHR_Impl::appGHeatingFuelTypes() const {
  ...
  bool AirConditionerVariableRefrigerantFlowFluidTemperatureControlHR::addTerminal(ZoneHVACTerminalUnitVariableRefrigerantFlow& vrf) {
    return getImpl<detail::AirConditionerVariableRefrigerantFlowFluidTemperatureControlHR_Impl>()->addTerminal(vrf);
  }
