...
namespace model {
  ...
  namespace detail {
    ...
    ZoneControlContaminantController_Impl::ZoneControlContaminantController_Impl(const IdfObject& idfObject, Model_Impl* model, bool keepHandle)
    ...
    boost::optional<Schedule> ZoneControlContaminantController_Impl::carbonDioxideControlAvailabilitySchedule() const {
      return getObject<ModelObject>().getModelObjectTarget<Schedule>(
        OS_ZoneControl_ContaminantControllerFields::CarbonDioxideControlAvailabilityScheduleName);
    }
    ...
    boost::optional<Schedule> ZoneControlContaminantController_Impl::minimumCarbonDioxideConcentrationSchedule() const {
      return getObject<ModelObject>().getModelObjectTarget<Schedule>(
        OS_ZoneControl_ContaminantControllerFields::MinimumCarbonDioxideConcentrationScheduleName);
    }

    boost::optional<Schedule> ZoneControlContaminantController_Impl::genericContaminantControlAvailabilitySchedule() const {
      return getObject<ModelObject>().getModelObjectTarget<Schedule>(
        OS_ZoneControl_ContaminantControllerFields::GenericContaminantControlAvailabilityScheduleName);
    }

    boost::optional<Schedule> ZoneControlContaminantController_Impl::genericContaminantSetpointSchedule() const {
      return getObject<ModelObject>().getModelObjectTarget<Schedule>(
        OS_ZoneControl_ContaminantControllerFields::GenericContaminantSetpointScheduleName);
    }
    ...
    bool ZoneControlContaminantController_Impl::setCarbonDioxideSetpointSchedule(Schedule& schedule) {
      bool result = setSchedule(OS_ZoneControl_ContaminantControllerFields::CarbonDioxideSetpointScheduleName, "ZoneControlContaminantController",
