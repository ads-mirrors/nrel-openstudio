...
namespace model {
  ...
  namespace detail {
    ...
    GlareSensor_Impl::GlareSensor_Impl(const openstudio::detail::WorkspaceObject_Impl& other, Model_Impl* model, bool keepHandle)
      : SpaceItem_Impl(other, model, keepHandle) {
      OS_ASSERT(other.iddObject().type() == GlareSensor::iddObjectType());
    }

    GlareSensor_Impl::GlareSensor_Impl(const GlareSensor_Impl& other, Model_Impl* model, bool keepHandle)
      : SpaceItem_Impl(other, model, keepHandle) {}
  ...
  GlareSensor::GlareSensor(const Model& model) : SpaceItem(GlareSensor::iddObjectType(), model) {
  ...
  /// @cond
  GlareSensor::GlareSensor(std::shared_ptr<detail::GlareSensor_Impl> impl) : SpaceItem(std::move(impl)) {}
  /// @endcond
