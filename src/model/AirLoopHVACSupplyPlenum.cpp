...
namespace model {
  ...
  namespace detail {
    ...
    AirLoopHVACSupplyPlenum_Impl::AirLoopHVACSupplyPlenum_Impl(const IdfObject& idfObject, Model_Impl* model, bool keepHandle)
      : Splitter_Impl(idfObject, model, keepHandle) {
      OS_ASSERT(idfObject.iddObject().type() == AirLoopHVACSupplyPlenum::iddObjectType());
    }

    AirLoopHVACSupplyPlenum_Impl::AirLoopHVACSupplyPlenum_Impl(const openstudio::detail::WorkspaceObject_Impl& other, Model_Impl* model,
                                                               bool keepHandle)
      : Splitter_Impl(other, model, keepHandle) {
      OS_ASSERT(other.iddObject().type() == AirLoopHVACSupplyPlenum::iddObjectType());
    }

    AirLoopHVACSupplyPlenum_Impl::AirLoopHVACSupplyPlenum_Impl(const AirLoopHVACSupplyPlenum_Impl& other, Model_Impl* model, bool keepHandle)
      : Splitter_Impl(other, model, keepHandle) {}
    ...
    bool AirLoopHVACSupplyPlenum_Impl::addBranchForZoneImpl(openstudio::model::ThermalZone& thermalZone, boost::optional<HVACComponent>& terminal) {
      ...
      returnPlenums = t_airLoopHVAC->demandComponents(splitter.get(), t_airLoopHVAC->demandOutletNode(), AirLoopHVACReturnPlenum::iddObjectType());
    ...
    std::vector<IdfObject> AirLoopHVACSupplyPlenum_Impl::remove() {
      ...
      if (boost::optional<AirLoopHVAC> t_airLoopHVAC = airLoopHVAC()) {
        ...
        for (auto it = t_outletModelObjects.rbegin(); it != t_outletModelObjects.rend(); ++it) {
