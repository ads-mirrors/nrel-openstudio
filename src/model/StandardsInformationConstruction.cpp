...
namespace model {
  ...
  namespace detail {
    ...
    StandardsInformationConstruction_Impl::StandardsInformationConstruction_Impl(const IdfObject& idfObject, Model_Impl* model, bool keepHandle)
      : ModelObject_Impl(idfObject, model, keepHandle) {
      OS_ASSERT(idfObject.iddObject().type() == StandardsInformationConstruction::iddObjectType());
    }

    StandardsInformationConstruction_Impl::StandardsInformationConstruction_Impl(const openstudio::detail::WorkspaceObject_Impl& other,
                                                                                 Model_Impl* model, bool keepHandle)
      : ModelObject_Impl(other, model, keepHandle) {
      OS_ASSERT(other.iddObject().type() == StandardsInformationConstruction::iddObjectType());
    }

    StandardsInformationConstruction_Impl::StandardsInformationConstruction_Impl(const StandardsInformationConstruction_Impl& other,
                                                                                 Model_Impl* model, bool keepHandle)
      : ModelObject_Impl(other, model, keepHandle) {}
    ...
    std::string StandardsInformationConstruction_Impl::perturbableLayerType() const {
      ...
      if (istringEqual("Not Applicable", *choiceValue)) {
        return result;
      }
    ...
    boost::optional<ParentObject> StandardsInformationConstruction_Impl::parent() const {
      ...
      if (candidate) {
        return candidate->cast<ParentObject>();
      }
      return boost::none;
    }
    ...
    bool StandardsInformationConstruction_Impl::setPerturbableLayer(unsigned layerIndex) {
      ...
      if (layerIndex >= oLayeredConstruction->numLayers()) {
        return false;
      }
  ...
  StandardsInformationConstruction::StandardsInformationConstruction(const ConstructionBase& construction)
  ...
  std::vector<std::string> StandardsInformationConstruction::standardPerturbableLayerTypeValues() {
    ...
    StringVector candidates =
      getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), OS_StandardsInformation_ConstructionFields::PerturbableLayerType);
    for (const std::string& candidate : candidates) {
      if ((candidate == "Not Applicable") || (candidate == "Other")) {
        continue;
      }
  ...
  std::vector<std::string> StandardsInformationConstruction::intendedSurfaceTypeValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), OS_StandardsInformation_ConstructionFields::IntendedSurfaceType);
  }

  std::vector<std::string> StandardsInformationConstruction::fenestrationTypeValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), OS_StandardsInformation_ConstructionFields::FenestrationType);
  }
  ...
  std::vector<std::string> StandardsInformationConstruction::fenestrationFrameTypeValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), OS_StandardsInformation_ConstructionFields::FenestrationFrameType);
  }
  ...
  std::vector<std::string> StandardsInformationConstruction::fenestrationTintValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), OS_StandardsInformation_ConstructionFields::FenestrationTint);
  }

  std::vector<std::string> StandardsInformationConstruction::fenestrationGasFillValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), OS_StandardsInformation_ConstructionFields::FenestrationGasFill);
  }
  ...
  /// @cond
  StandardsInformationConstruction::StandardsInformationConstruction(std::shared_ptr<detail::StandardsInformationConstruction_Impl> impl)
