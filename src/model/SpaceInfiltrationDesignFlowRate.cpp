...
namespace model {
  ...
  namespace detail {
    ...
    double SpaceInfiltrationDesignFlowRate_Impl::getFlowPerSpaceFloorArea(double floorArea, double exteriorSurfaceArea, double exteriorWallArea,
                                                                          double airVolume) const {
      std::string method = designFlowRateCalculationMethod();
    ...
    double SpaceInfiltrationDesignFlowRate_Impl::getFlowPerExteriorSurfaceArea(double floorArea, double exteriorSurfaceArea, double exteriorWallArea,
                                                                               double airVolume) const {
      std::string method = designFlowRateCalculationMethod();
    ...
    double SpaceInfiltrationDesignFlowRate_Impl::getFlowPerExteriorWallArea(double floorArea, double exteriorSurfaceArea, double exteriorWallArea,
                                                                            double airVolume) const {
      std::string method = designFlowRateCalculationMethod();
    ...
    double SpaceInfiltrationDesignFlowRate_Impl::getAirChangesPerHour(double floorArea, double exteriorSurfaceArea, double exteriorWallArea,
                                                                      double airVolume) const {
      std::string method = designFlowRateCalculationMethod();
    ...
    boost::optional<Schedule> SpaceInfiltrationDesignFlowRate_Impl::schedule() const {
      boost::optional<Schedule> result =
        getObject<ModelObject>().getModelObjectTarget<Schedule>(OS_SpaceInfiltration_DesignFlowRateFields::ScheduleName);
      if (!result) {
        // search upwards
    ...
    bool SpaceInfiltrationDesignFlowRate_Impl::setSchedule(Schedule& schedule) {
      bool result = ModelObject_Impl::setSchedule(OS_SpaceInfiltration_DesignFlowRateFields::ScheduleName, "SpaceInfiltrationDesignFlowRate",
  ...
  double SpaceInfiltrationDesignFlowRate::getDesignFlowRate(double floorArea, double exteriorSurfaceArea, double exteriorWallArea,
                                                            double airVolume) const {
    return getImpl<detail::SpaceInfiltrationDesignFlowRate_Impl>()->getDesignFlowRate(floorArea, exteriorSurfaceArea, exteriorWallArea, airVolume);
  }

  double SpaceInfiltrationDesignFlowRate::getFlowPerSpaceFloorArea(double floorArea, double exteriorSurfaceArea, double exteriorWallArea,
                                                                   double airVolume) const {
    return getImpl<detail::SpaceInfiltrationDesignFlowRate_Impl>()->getFlowPerSpaceFloorArea(floorArea, exteriorSurfaceArea, exteriorWallArea,
                                                                                             airVolume);
  }

  double SpaceInfiltrationDesignFlowRate::getFlowPerExteriorSurfaceArea(double floorArea, double exteriorSurfaceArea, double exteriorWallArea,
                                                                        double airVolume) const {
    return getImpl<detail::SpaceInfiltrationDesignFlowRate_Impl>()->getFlowPerExteriorSurfaceArea(floorArea, exteriorSurfaceArea, exteriorWallArea,
                                                                                                  airVolume);
  }

  double SpaceInfiltrationDesignFlowRate::getFlowPerExteriorWallArea(double floorArea, double exteriorSurfaceArea, double exteriorWallArea,
                                                                     double airVolume) const {
    return getImpl<detail::SpaceInfiltrationDesignFlowRate_Impl>()->getFlowPerExteriorWallArea(floorArea, exteriorSurfaceArea, exteriorWallArea,
                                                                                               airVolume);
  }

  double SpaceInfiltrationDesignFlowRate::getAirChangesPerHour(double floorArea, double exteriorSurfaceArea, double exteriorWallArea,
                                                               double airVolume) const {
    return getImpl<detail::SpaceInfiltrationDesignFlowRate_Impl>()->getAirChangesPerHour(floorArea, exteriorSurfaceArea, exteriorWallArea, airVolume);
  }
