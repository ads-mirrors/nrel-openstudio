...
namespace model {
  ...
  namespace detail {
    ...
    CoilHeatingFourPipeBeam_Impl::CoilHeatingFourPipeBeam_Impl(const IdfObject& idfObject, Model_Impl* model, bool keepHandle)
      : StraightComponent_Impl(idfObject, model, keepHandle) {
      OS_ASSERT(idfObject.iddObject().type() == CoilHeatingFourPipeBeam::iddObjectType());
    }

    CoilHeatingFourPipeBeam_Impl::CoilHeatingFourPipeBeam_Impl(const openstudio::detail::WorkspaceObject_Impl& other, Model_Impl* model,
                                                               bool keepHandle)
      : StraightComponent_Impl(other, model, keepHandle) {
      OS_ASSERT(other.iddObject().type() == CoilHeatingFourPipeBeam::iddObjectType());
    }

    CoilHeatingFourPipeBeam_Impl::CoilHeatingFourPipeBeam_Impl(const CoilHeatingFourPipeBeam_Impl& other, Model_Impl* model, bool keepHandle)
      : StraightComponent_Impl(other, model, keepHandle) {}
    ...
    bool CoilHeatingFourPipeBeam_Impl::setBeamRatedHeatingRoomAirHotWaterTemperatureDifference(
      double beamRatedHeatingRoomAirHotWaterTemperatureDifference) {
      bool result = setDouble(OS_Coil_Heating_FourPipeBeamFields::BeamRatedHeatingRoomAirHotWaterTemperatureDifference,
    ...
    bool CoilHeatingFourPipeBeam_Impl::setBeamRatedHotWaterVolumeFlowRateperBeamLength(double beamRatedHotWaterVolumeFlowRateperBeamLength) {
      bool result =
        setDouble(OS_Coil_Heating_FourPipeBeamFields::BeamRatedHotWaterVolumeFlowRateperBeamLength, beamRatedHotWaterVolumeFlowRateperBeamLength);
      return result;
    }
    ...
    Curve CoilHeatingFourPipeBeam_Impl::beamHeatingCapacityTemperatureDifferenceModificationFactorCurve() const {
      boost::optional<Curve> c = getObject<ModelObject>().getModelObjectTarget<Curve>(
        OS_Coil_Heating_FourPipeBeamFields::BeamHeatingCapacityTemperatureDifferenceModificationFactorCurveName);
      if (!c) {
    ...
    bool CoilHeatingFourPipeBeam_Impl::setBeamHeatingCapacityTemperatureDifferenceModificationFactorCurve(const Curve& curve) {
      bool result =
        setPointer(OS_Coil_Heating_FourPipeBeamFields::BeamHeatingCapacityTemperatureDifferenceModificationFactorCurveName, curve.handle());
      return result;
    }
    ...
    Curve CoilHeatingFourPipeBeam_Impl::beamHeatingCapacityAirFlowModificationFactorCurve() const {
      boost::optional<Curve> c = getObject<ModelObject>().getModelObjectTarget<Curve>(
        OS_Coil_Heating_FourPipeBeamFields::BeamHeatingCapacityAirFlowModificationFactorCurveName);
      if (!c) {
    ...
    Curve CoilHeatingFourPipeBeam_Impl::beamHeatingCapacityHotWaterFlowModificationFactorCurve() const {
      boost::optional<Curve> c = getObject<ModelObject>().getModelObjectTarget<Curve>(
        OS_Coil_Heating_FourPipeBeamFields::BeamHeatingCapacityHotWaterFlowModificationFactorCurveName);
      if (!c) {
    ...
    boost::optional<AirTerminalSingleDuctConstantVolumeFourPipeBeam>
      CoilHeatingFourPipeBeam_Impl::airTerminalSingleDuctConstantVolumeFourPipeBeam() const {
    ...
    ComponentType CoilHeatingFourPipeBeam_Impl::componentType() const {
      return ComponentType::Heating;
    }

    std::vector<FuelType> CoilHeatingFourPipeBeam_Impl::coolingFuelTypes() const {
      return {};
    }

    std::vector<FuelType> CoilHeatingFourPipeBeam_Impl::heatingFuelTypes() const {
    ...
    std::vector<AppGFuelType> CoilHeatingFourPipeBeam_Impl::appGHeatingFuelTypes() const {
      if (auto p_ = plantLoop()) {
  ...
  CoilHeatingFourPipeBeam::CoilHeatingFourPipeBeam(const Model& model) : StraightComponent(CoilHeatingFourPipeBeam::iddObjectType(), model) {
    ...
    TableLookup heatCapModFuncOfSAFlow(model);
    {
      heatCapModFuncOfSAFlow.setName("HeatCapModFuncOfSAFlow");
      heatCapModFuncOfSAFlow.setMinimumOutput(0.8234);
      heatCapModFuncOfSAFlow.setMaximumOutput(1.0778);
      ...
      heatCapModFuncOfSAFlowVar1.setMinimumValue(0.714);
      heatCapModFuncOfSAFlowVar1.setMaximumValue(1.2857);
      heatCapModFuncOfSAFlowVar1.setUnitType("Dimensionless");
      heatCapModFuncOfSAFlowVar1.setValues({0.714286, 1.0, 1.2857});
    }
  ...
  bool CoilHeatingFourPipeBeam::setBeamRatedHeatingRoomAirHotWaterTemperatureDifference(double beamRatedHeatingRoomAirHotWaterTemperatureDifference) {
    return getImpl<detail::CoilHeatingFourPipeBeam_Impl>()->setBeamRatedHeatingRoomAirHotWaterTemperatureDifference(
      beamRatedHeatingRoomAirHotWaterTemperatureDifference);
  }
  ...
  bool CoilHeatingFourPipeBeam::setBeamRatedHotWaterVolumeFlowRateperBeamLength(double beamRatedHotWaterVolumeFlowRateperBeamLength) {
    return getImpl<detail::CoilHeatingFourPipeBeam_Impl>()->setBeamRatedHotWaterVolumeFlowRateperBeamLength(
  ...
  /// @cond
  CoilHeatingFourPipeBeam::CoilHeatingFourPipeBeam(std::shared_ptr<detail::CoilHeatingFourPipeBeam_Impl> impl) : StraightComponent(impl) {}
  /// @endcond
