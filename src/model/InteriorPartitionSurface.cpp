...
namespace model {
  ...
  namespace detail {
    ...
    InteriorPartitionSurface_Impl::InteriorPartitionSurface_Impl(const IdfObject& idfObject, Model_Impl* model, bool keepHandle)
      : PlanarSurface_Impl(idfObject, model, keepHandle) {
      OS_ASSERT(idfObject.iddObject().type() == InteriorPartitionSurface::iddObjectType());
    }

    InteriorPartitionSurface_Impl::InteriorPartitionSurface_Impl(const openstudio::detail::WorkspaceObject_Impl& other, Model_Impl* model,
                                                                 bool keepHandle)
      : PlanarSurface_Impl(other, model, keepHandle) {
      OS_ASSERT(other.iddObject().type() == InteriorPartitionSurface::iddObjectType());
    }

    InteriorPartitionSurface_Impl::InteriorPartitionSurface_Impl(const InteriorPartitionSurface_Impl& other, Model_Impl* model, bool keepHandle)
      : PlanarSurface_Impl(other, model, keepHandle) {}
    ...
    boost::optional<std::pair<ConstructionBase, int>> InteriorPartitionSurface_Impl::constructionWithSearchDistance() const {
      ...
      boost::optional<ConstructionBase> construction =
        getObject<ModelObject>().getModelObjectTarget<ConstructionBase>(OS_InteriorPartitionSurfaceFields::ConstructionName);
      if (construction) {
    ...
    bool InteriorPartitionSurface_Impl::setInteriorPartitionSurfaceGroup(const InteriorPartitionSurfaceGroup& interiorPartitionSurfaceGroup) {
      return setPointer(OS_InteriorPartitionSurfaceFields::InteriorPartitionSurfaceGroupName, interiorPartitionSurfaceGroup.handle());
    }
