...
namespace model {
  ...
  namespace detail {
    ...
    FluidCoolerTwoSpeed_Impl::FluidCoolerTwoSpeed_Impl(const IdfObject& idfObject, Model_Impl* model, bool keepHandle)
      : StraightComponent_Impl(idfObject, model, keepHandle) {
      OS_ASSERT(idfObject.iddObject().type() == FluidCoolerTwoSpeed::iddObjectType());
    }

    FluidCoolerTwoSpeed_Impl::FluidCoolerTwoSpeed_Impl(const openstudio::detail::WorkspaceObject_Impl& other, Model_Impl* model, bool keepHandle)
      : StraightComponent_Impl(other, model, keepHandle) {
      OS_ASSERT(other.iddObject().type() == FluidCoolerTwoSpeed::iddObjectType());
    }

    FluidCoolerTwoSpeed_Impl::FluidCoolerTwoSpeed_Impl(const FluidCoolerTwoSpeed_Impl& other, Model_Impl* model, bool keepHandle)
      : StraightComponent_Impl(other, model, keepHandle) {}

    const std::vector<std::string>& FluidCoolerTwoSpeed_Impl::outputVariableNames() const {
      static const std::vector<std::string> result{"Cooling Tower Fan Electricity Rate", "Cooling Tower Fan Electricity Energy",
                                                   "Cooling Tower Heat Transfer Rate",   "Cooling Tower Inlet Temperature",
                                                   "Cooling Tower Outlet Temperature",   "Cooling Tower Mass Flow Rate"};
      return result;
    }
    ...
    std::vector<FuelType> FluidCoolerTwoSpeed_Impl::coolingFuelTypes() const {
      return {FuelType::Electricity};
    }

    std::vector<FuelType> FluidCoolerTwoSpeed_Impl::heatingFuelTypes() const {
      return {};
    }

    std::vector<AppGFuelType> FluidCoolerTwoSpeed_Impl::appGHeatingFuelTypes() const {
      return {};
    }
  ...
  std::vector<std::string> FluidCoolerTwoSpeed::performanceInputMethodValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), OS_FluidCooler_TwoSpeedFields::PerformanceInputMethod);
  }
