...
namespace model {
  ...
  namespace detail {
    ...
    ElectricLoadCenterDistribution_Impl::ElectricLoadCenterDistribution_Impl(const IdfObject& idfObject, Model_Impl* model, bool keepHandle)
      : ParentObject_Impl(idfObject, model, keepHandle) {
      OS_ASSERT(idfObject.iddObject().type() == ElectricLoadCenterDistribution::iddObjectType());
    }

    ElectricLoadCenterDistribution_Impl::ElectricLoadCenterDistribution_Impl(const openstudio::detail::WorkspaceObject_Impl& other, Model_Impl* model,
                                                                             bool keepHandle)
      : ParentObject_Impl(other, model, keepHandle) {
      OS_ASSERT(other.iddObject().type() == ElectricLoadCenterDistribution::iddObjectType());
    }

    ElectricLoadCenterDistribution_Impl::ElectricLoadCenterDistribution_Impl(const ElectricLoadCenterDistribution_Impl& other, Model_Impl* model,
                                                                             bool keepHandle)
      : ParentObject_Impl(other, model, keepHandle) {}

    const std::vector<std::string>& ElectricLoadCenterDistribution_Impl::outputVariableNames() const {
      static const std::vector<std::string> result{"Electric Load Center Requested Electricity Rate",
                                                   "Electric Load Center Produced Electricity Rate",
                                                   "Electric Load Center Produced Electricity Energy", "Electric Load Center Produced Thermal Rate",
    ...
    boost::optional<ElectricLoadCenterTransformer> ElectricLoadCenterDistribution_Impl::transformer() const {
      return getObject<ModelObject>().getModelObjectTarget<ElectricLoadCenterTransformer>(
        OS_ElectricLoadCenter_DistributionFields::TransformerObjectName);
    }
    ...
    boost::optional<ElectricLoadCenterStorageConverter> ElectricLoadCenterDistribution_Impl::storageConverter() const {
      return getObject<ModelObject>().getModelObjectTarget<ElectricLoadCenterStorageConverter>(
        OS_ElectricLoadCenter_DistributionFields::StorageConverterObjectName);
    }
    ...
    boost::optional<Schedule> ElectricLoadCenterDistribution_Impl::storageChargePowerFractionSchedule() const {
      return getObject<ModelObject>().getModelObjectTarget<Schedule>(
        OS_ElectricLoadCenter_DistributionFields::StorageChargePowerFractionScheduleName);
    }
    ...
    boost::optional<Schedule> ElectricLoadCenterDistribution_Impl::storageDischargePowerFractionSchedule() const {
      return getObject<ModelObject>().getModelObjectTarget<Schedule>(
        OS_ElectricLoadCenter_DistributionFields::StorageDischargePowerFractionScheduleName);
    }
    ...
    Schedule ElectricLoadCenterDistribution_Impl::storageControlUtilityDemandTargetFractionSchedule() const {
      boost::optional<Schedule> sch = getObject<ModelObject>().getModelObjectTarget<Schedule>(
        OS_ElectricLoadCenter_DistributionFields::StorageControlUtilityDemandTargetFractionScheduleName);
      if (sch) {
        return sch.get();
      } else {
    ...
    bool ElectricLoadCenterDistribution_Impl::setTrackScheduleSchemeSchedule(Schedule& schedule) {
      bool result = setSchedule(OS_ElectricLoadCenter_DistributionFields::TrackScheduleNameSchemeScheduleName, "ElectricLoadCenterDistribution",
                                "Track  Scheme", schedule);
      return result;
    }
    ...
    ModelObjectList ElectricLoadCenterDistribution_Impl::generatorModelObjectList() const {
      boost::optional<ModelObjectList> result =
        getObject<ModelObject>().getModelObjectTarget<ModelObjectList>(OS_ElectricLoadCenter_DistributionFields::GeneratorListName);
      OS_ASSERT(result);
      return result.get();
    }
    ...
    bool ElectricLoadCenterDistribution_Impl::setStorageChargePowerFractionSchedule(Schedule& schedule) {
      bool result = setSchedule(OS_ElectricLoadCenter_DistributionFields::StorageChargePowerFractionScheduleName, "ElectricLoadCenterDistribution",
    ...
    bool ElectricLoadCenterDistribution_Impl::setStorageDischargePowerFractionSchedule(Schedule& schedule) {
      bool result = setSchedule(OS_ElectricLoadCenter_DistributionFields::StorageDischargePowerFractionScheduleName, "ElectricLoadCenterDistribution",
    ...
    bool ElectricLoadCenterDistribution_Impl::setStorageControlUtilityDemandTargetFractionSchedule(Schedule& schedule) {
      bool result = setSchedule(OS_ElectricLoadCenter_DistributionFields::StorageControlUtilityDemandTargetFractionScheduleName,
                                "ElectricLoadCenterDistribution", "Storage Control Utility Demand Target Fraction", schedule);
      return result;
    }
    ...
    bool ElectricLoadCenterDistribution_Impl::validityCheck() const {
      ...
      if (inv && bussWithInverter) {
        LOG(Info, briefDescription() << ": Your Electric Buss Type '" << bussType
                                     << "' is compatible with inverter objects and you do have an inverter '" << inv->name().get() << "'");
        ...
        LOG(Warn, briefDescription() << ": Your Electric Buss Type '" << bussType
                                     << "' is not compatible with inverter objects. The inverter object '" << inv->name().get()
        ...
        result = false;
        LOG(Error, briefDescription() << ": Your Electric Buss Type '" << bussType << "' Requires an inverter but you didn't specify one");
      }
      ...
      if (elcSto && bussWithStorage) {
        ...
        LOG(Info, briefDescription() << ": Your Electric Buss Type '" << bussType
                                     << "' is compatible with storage objects and you do have an ELC:Storage:Simple '" << elcSto->name().get()
                                     << "'");
        ...
        LOG(Warn,
            briefDescription() << ": Your Electric Buss Type '" << bussType
        ...
        LOG(Error,
            briefDescription() << ": Your Electric Buss Type '" << bussType << "' Requires an electrical Storage object but you didn't specify one");
      }
      // Case 4: there's no inverter and a buss type without inverter: nothing needs to be done
  ...
  std::vector<std::string> ElectricLoadCenterDistribution::electricalBussTypeValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), OS_ElectricLoadCenter_DistributionFields::ElectricalBussType);
  }

  std::vector<std::string> ElectricLoadCenterDistribution::storageOperationSchemeValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), OS_ElectricLoadCenter_DistributionFields::StorageOperationScheme);
  }
