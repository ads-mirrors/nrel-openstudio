...
namespace model {
  ...
  namespace detail {
    ...
    DaylightingControl_Impl::DaylightingControl_Impl(const openstudio::detail::WorkspaceObject_Impl& other, Model_Impl* model, bool keepHandle)
      : SpaceItem_Impl(other, model, keepHandle) {
      OS_ASSERT(other.iddObject().type() == DaylightingControl::iddObjectType());
    }

    DaylightingControl_Impl::DaylightingControl_Impl(const DaylightingControl_Impl& other, Model_Impl* model, bool keepHandle)
      : SpaceItem_Impl(other, model, keepHandle) {}
    ...
    bool
      DaylightingControl_Impl::setMinimumInputPowerFractionforContinuousDimmingControl(double minimumInputPowerFractionforContinuousDimmingControl) {
      bool result = setDouble(OS_Daylighting_ControlFields::MinimumInputPowerFractionforContinuousDimmingControl,
    ...
    bool DaylightingControl_Impl::setMinimumLightOutputFractionforContinuousDimmingControl(
      double minimumLightOutputFractionforContinuousDimmingControl) {
      bool result = setDouble(OS_Daylighting_ControlFields::MinimumLightOutputFractionforContinuousDimmingControl,
    ...
    bool DaylightingControl_Impl::setProbabilityLightingwillbeResetWhenNeededinManualSteppedControl(
      double probabilityLightingwillbeResetWhenNeededinManualSteppedControl) {
      bool result = setDouble(OS_Daylighting_ControlFields::ProbabilityLightingwillbeResetWhenNeededinManualSteppedControl,
    ...
    Point3d DaylightingControl_Impl::position() const {
      Point3d result(this->positionXCoordinate(), this->positionYCoordinate(), this->positionZCoordinate());
      return result;
    }
  ...
  DaylightingControl::DaylightingControl(const Model& model) : SpaceItem(DaylightingControl::iddObjectType(), model) {
  ...
  std::vector<std::string> DaylightingControl::validLightingControlTypeValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), OS_Daylighting_ControlFields::LightingControlType);
  }
  ...
  bool DaylightingControl::setMinimumInputPowerFractionforContinuousDimmingControl(double minimumInputPowerFractionforContinuousDimmingControl) {
    return getImpl<detail::DaylightingControl_Impl>()->setMinimumInputPowerFractionforContinuousDimmingControl(
      minimumInputPowerFractionforContinuousDimmingControl);
  }
  ...
  bool DaylightingControl::setMinimumLightOutputFractionforContinuousDimmingControl(double minimumLightOutputFractionforContinuousDimmingControl) {
    return getImpl<detail::DaylightingControl_Impl>()->setMinimumLightOutputFractionforContinuousDimmingControl(
      minimumLightOutputFractionforContinuousDimmingControl);
  }
  ...
  bool DaylightingControl::setProbabilityLightingwillbeResetWhenNeededinManualSteppedControl(
    double probabilityLightingwillbeResetWhenNeededinManualSteppedControl) {
    return getImpl<detail::DaylightingControl_Impl>()->setProbabilityLightingwillbeResetWhenNeededinManualSteppedControl(
      probabilityLightingwillbeResetWhenNeededinManualSteppedControl);
  }
  ...
  /// @cond
  DaylightingControl::DaylightingControl(std::shared_ptr<detail::DaylightingControl_Impl> impl) : SpaceItem(std::move(impl)) {}
  /// @endcond
