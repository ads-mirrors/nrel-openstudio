...
namespace model {
  ...
  namespace detail {
    ...
    GeneratorMicroTurbine_Impl::GeneratorMicroTurbine_Impl(const IdfObject& idfObject, Model_Impl* model, bool keepHandle)
      : Generator_Impl(idfObject, model, keepHandle) {
      OS_ASSERT(idfObject.iddObject().type() == GeneratorMicroTurbine::iddObjectType());
    }

    GeneratorMicroTurbine_Impl::GeneratorMicroTurbine_Impl(const openstudio::detail::WorkspaceObject_Impl& other, Model_Impl* model, bool keepHandle)
      : Generator_Impl(other, model, keepHandle) {
      OS_ASSERT(other.iddObject().type() == GeneratorMicroTurbine::iddObjectType());
    }

    GeneratorMicroTurbine_Impl::GeneratorMicroTurbine_Impl(const GeneratorMicroTurbine_Impl& other, Model_Impl* model, bool keepHandle)
      : Generator_Impl(other, model, keepHandle) {}
    ...
    const std::vector<std::string>& GeneratorMicroTurbine_Impl::outputVariableNames() const {
      static const std::vector<std::string> result{
        "Generator Produced AC Electricity Rate", "Generator Produced AC Electricity Energy", "Generator LHV Basis Electric Efficiency",
        // <FuelType>
        "Generator NaturalGas HHV Basis Rate", "Generator NaturalGas HHV Basis Energy", "Generator NaturalGas Mass Flow Rate",

        "Generator Propane HHV Basis Rate", "Generator Propane HHV Basis Energy", "Generator Propane Mass Flow Rate",
        // </FuelType>
        "Generator Fuel HHV Basis Rate", "Generator Fuel HHV Basis Energy",
        ...
        "Generator Standby Electricity Rate", "Generator Standby Electric Energy", "Generator Ancillary Electricity Rate",
        "Generator Ancillary Electricity Energy", "Generator Exhaust Air Mass Flow Rate", "Generator Exhaust Air Temperature"};
      return result;
    }
    ...
    double GeneratorMicroTurbine_Impl::maximumFullLoadElectricalPowerOutput() const {
      ...
      boost::optional<double> maximumFullLoadElectricalPowerOutput =
        getDouble(OS_Generator_MicroTurbineFields::MaximumFullLoadElectricalPowerOutput, true);
    ...
    Curve GeneratorMicroTurbine_Impl::electricalPowerFunctionofTemperatureandElevationCurve() const {
      boost::optional<Curve> curve = getObject<ModelObject>().getModelObjectTarget<Curve>(
    ...
    Curve GeneratorMicroTurbine_Impl::electricalEfficiencyFunctionofTemperatureCurve() const {
      boost::optional<Curve> curve =
        getObject<ModelObject>().getModelObjectTarget<Curve>(OS_Generator_MicroTurbineFields::ElectricalEfficiencyFunctionofTemperatureCurveName);
      OS_ASSERT(curve);
      return curve.get();
    }
    ...
    Curve GeneratorMicroTurbine_Impl::electricalEfficiencyFunctionofPartLoadRatioCurve() const {
      boost::optional<Curve> curve =
        getObject<ModelObject>().getModelObjectTarget<Curve>(OS_Generator_MicroTurbineFields::ElectricalEfficiencyFunctionofPartLoadRatioCurveName);
      OS_ASSERT(curve);
      return curve.get();
    }
    /*  Curve GeneratorMicroTurbine_Impl::electricalEfficiencyFunctionofPartLoadRatioCurve() const {
    ...
    boost::optional<GeneratorMicroTurbineHeatRecovery> GeneratorMicroTurbine_Impl::generatorMicroTurbineHeatRecovery() const {
      return getObject<ModelObject>().getModelObjectTarget<GeneratorMicroTurbineHeatRecovery>(
        OS_Generator_MicroTurbineFields::GeneratorMicroTurbineHeatRecoveryName);
    }
    ...
    boost::optional<Curve> GeneratorMicroTurbine_Impl::exhaustAirTemperatureFunctionofTemperatureCurve() const {
      return getObject<ModelObject>().getModelObjectTarget<Curve>(
        OS_Generator_MicroTurbineFields::ExhaustAirTemperatureFunctionofTemperatureCurveName);
    }

    boost::optional<Curve> GeneratorMicroTurbine_Impl::exhaustAirTemperatureFunctionofPartLoadRatioCurve() const {
      return getObject<ModelObject>().getModelObjectTarget<Curve>(
        OS_Generator_MicroTurbineFields::ExhaustAirTemperatureFunctionofPartLoadRatioCurveName);
    }

    bool GeneratorMicroTurbine_Impl::setAvailabilitySchedule(Schedule& schedule) {
      bool result = setSchedule(OS_Generator_MicroTurbineFields::AvailabilityScheduleName, "GeneratorMicroTurbine", "Availability", schedule);
      return result;
    }
    ...
    bool
      ...
      bool result = setDouble(OS_Generator_MicroTurbineFields::ReferenceElectricalEfficiencyUsingLowerHeatingValue,
    ...
    bool
      GeneratorMicroTurbine_Impl::setGeneratorMicroTurbineHeatRecovery(const GeneratorMicroTurbineHeatRecovery& generatorMicroTurbineHeatRecovery) {
  ...
  */
  ...
  GeneratorMicroTurbine::GeneratorMicroTurbine(const Model& model) : Generator(GeneratorMicroTurbine::iddObjectType(), model) {
...
! x = Dry-Bulb Temperature of Combustion Inlet Air (C)
  ...
  std::vector<std::string> GeneratorMicroTurbine::validFuelTypeValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), OS_Generator_MicroTurbineFields::FuelType);
  }
...
void GeneratorMicroTurbine::resetCombustionAirOutletNode() {
  ...
  /// @cond
  GeneratorMicroTurbine::GeneratorMicroTurbine(std::shared_ptr<detail::GeneratorMicroTurbine_Impl> impl) : Generator(std::move(impl)) {}
  /// @endcond
