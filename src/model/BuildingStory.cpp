...
namespace model {
  ...
  namespace detail {
    ...
    BuildingStory_Impl::BuildingStory_Impl(const openstudio::detail::WorkspaceObject_Impl& other, Model_Impl* model, bool keepHandle)
      : ModelObject_Impl(other, model, keepHandle) {
      OS_ASSERT(other.iddObject().type() == BuildingStory::iddObjectType());
    }

    BuildingStory_Impl::BuildingStory_Impl(const BuildingStory_Impl& other, Model_Impl* model, bool keepHandle)
      : ModelObject_Impl(other, model, keepHandle) {}
    ...
    bool BuildingStory_Impl::setDefaultConstructionSetAsModelObject(boost::optional<ModelObject> modelObject) {
      if (modelObject) {
    ...
    bool BuildingStory_Impl::setDefaultScheduleSetAsModelObject(boost::optional<ModelObject> modelObject) {
      if (modelObject) {
  ...
  BuildingStory::BuildingStory(const Model& model) : ModelObject(BuildingStory::iddObjectType(), model) {
