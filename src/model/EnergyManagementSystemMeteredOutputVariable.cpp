...
namespace model {
  ...
  namespace detail {
    ...
    EnergyManagementSystemMeteredOutputVariable_Impl::EnergyManagementSystemMeteredOutputVariable_Impl(const IdfObject& idfObject, Model_Impl* model,
                                                                                                       bool keepHandle)
      : ModelObject_Impl(idfObject, model, keepHandle) {
      OS_ASSERT(idfObject.iddObject().type() == EnergyManagementSystemMeteredOutputVariable::iddObjectType());
    }

    EnergyManagementSystemMeteredOutputVariable_Impl::EnergyManagementSystemMeteredOutputVariable_Impl(
    ...
    EnergyManagementSystemMeteredOutputVariable_Impl::EnergyManagementSystemMeteredOutputVariable_Impl(
      const EnergyManagementSystemMeteredOutputVariable_Impl& other, Model_Impl* model, bool keepHandle)
      : ModelObject_Impl(other, model, keepHandle) {}
    ...
    boost::optional<EnergyManagementSystemCurveOrTableIndexVariable>
      EnergyManagementSystemMeteredOutputVariable_Impl::emsCurveOrTableIndexVariable() const {
    ...
    boost::optional<EnergyManagementSystemConstructionIndexVariable>
      EnergyManagementSystemMeteredOutputVariable_Impl::emsConstructionIndexVariable() const {
  ...
  EnergyManagementSystemMeteredOutputVariable::EnergyManagementSystemMeteredOutputVariable(
    const Model& model, const EnergyManagementSystemCurveOrTableIndexVariable& object)
    : ModelObject(EnergyManagementSystemMeteredOutputVariable::iddObjectType(), model) {
    OS_ASSERT(getImpl<detail::EnergyManagementSystemMeteredOutputVariable_Impl>());
    bool ok = setEMSVariableName(object);
    if (!ok) {
  ...
  EnergyManagementSystemMeteredOutputVariable::EnergyManagementSystemMeteredOutputVariable(
    const Model& model, const EnergyManagementSystemConstructionIndexVariable& object)
    : ModelObject(EnergyManagementSystemMeteredOutputVariable::iddObjectType(), model) {
    OS_ASSERT(getImpl<detail::EnergyManagementSystemMeteredOutputVariable_Impl>());
    bool ok = setEMSVariableName(object);
    if (!ok) {
  ...
  std::vector<std::string> EnergyManagementSystemMeteredOutputVariable::groupTypeValues() {
    return getIddKeyNames(IddFactory::instance().getObject(iddObjectType()).get(), OS_EnergyManagementSystem_MeteredOutputVariableFields::GroupType);
  }
