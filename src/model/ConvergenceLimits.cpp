...
namespace model {
  ...
  namespace detail {
    ...
    ConvergenceLimits_Impl::ConvergenceLimits_Impl(const openstudio::detail::WorkspaceObject_Impl& other, Model_Impl* model, bool keepHandle)
      : ModelObject_Impl(other, model, keepHandle) {
      OS_ASSERT(other.iddObject().type() == ConvergenceLimits::iddObjectType());
    }

    ConvergenceLimits_Impl::ConvergenceLimits_Impl(const ConvergenceLimits_Impl& other, Model_Impl* model, bool keepHandle)
      : ModelObject_Impl(other, model, keepHandle) {}
  ...
  ConvergenceLimits::ConvergenceLimits(Model& model) : ModelObject(ConvergenceLimits::iddObjectType(), model) {
