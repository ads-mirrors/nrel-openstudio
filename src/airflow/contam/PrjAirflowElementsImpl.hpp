  ...
  namespace detail {
    ...
    class PlrOrfImpl
    {
     public:
      ...
      PlrOrfImpl(int nr, int icon, std::string name, std::string desc, double lam, double turb, double expt, double area, double dia, double coef,
    ...
    class PlrLeakImpl
    {
     public:
      ...
      PlrLeakImpl(int nr, int icon, std::string name, std::string desc, double lam, double turb, double expt, double coef, double pres, double area1,
    ...
    class PlrConnImpl
    {
     public:
      ...
      PlrConnImpl(int nr, int icon, std::string name, std::string desc, double lam, double turb, double expt, double area, double coef, int u_A);
    ...
    class PlrTest1Impl
    {
     public:
      ...
      PlrTest1Impl(int nr, int icon, std::string name, std::string desc, double lam, double turb, double expt, double dP, double Flow, int u_P,
                   int u_F);
    ...
    class PlrTest2Impl
    {
     public:
      ...
      PlrTest2Impl(int nr, int icon, std::string name, std::string desc, double lam, double turb, double expt, double dP1, double F1, double dP2,
    ...
    class PlrCrackImpl
    {
     public:
      ...
      PlrCrackImpl(int nr, int icon, std::string name, std::string desc, double lam, double turb, double expt, double length, double width, int u_L,
                   int u_W);
    ...
    class PlrStairImpl
    {
     public:
      ...
      PlrStairImpl(int nr, int icon, std::string name, std::string desc, double lam, double turb, double expt, double Ht, double Area, double peo,
                   int tread, int u_A, int u_D);
      PlrStairImpl(int nr, int icon, std::string name, std::string desc, std::string lam, std::string turb, std::string expt, std::string Ht,
    ...
    class PlrShaftImpl
    {
     public:
      ...
      PlrShaftImpl(int nr, int icon, std::string name, std::string desc, double lam, double turb, double expt, double Ht, double area, double perim,
                   double rough, int u_A, int u_D, int u_P, int u_R);
      PlrShaftImpl(int nr, int icon, std::string name, std::string desc, std::string lam, std::string turb, std::string expt, std::string Ht,
    ...
    class PlrBackDamperImpl
    {
     public:
      ...
      PlrBackDamperImpl(int nr, int icon, std::string name, std::string desc, std::string lam, std::string Cp, std::string xp, std::string Cn,
                        std::string xn);
      void read(Reader& reader);
      std::string write(std::string dataType);
      void readDetails(Reader& input);
    ...
    class QfrCrackImpl
    {
     public:
      ...
      /** Create a new object. */
      QfrCrackImpl(int nr, int icon, std::string name, std::string desc, double a, double b, double length, double width, double depth, int nB,
    ...
    class QfrTest2Impl
    {
     public:
      ...
      QfrTest2Impl(int nr, int icon, std::string name, std::string desc, double a, double b, double dP1, double F1, double dP2, double F2, int u_P1,
                   int u_F1, int u_P2, int u_F2);
      QfrTest2Impl(int nr, int icon, std::string name, std::string desc, std::string a, std::string b, std::string dP1, std::string F1,
    ...
    class AfeDorImpl
    {
     public:
      ...
      /** Create a new object. */
      AfeDorImpl(int nr, int icon, std::string name, std::string desc, double lam, double turb, double expt, double dTmin, double ht, double wd,
    ...
    class DrPl2Impl
    {
     public:
      ...
      /** Create a new object. */
      DrPl2Impl(int nr, int icon, std::string name, std::string desc, double lam, double turb, double expt, double dH, double ht, double wd,
                double cd, int u_H, int u_W);
      /** Create a new object. */
      DrPl2Impl(int nr, int icon, std::string name, std::string desc, std::string lam, std::string turb, std::string expt, std::string dH,
    ...
    class AfeFanImpl
    {
     public:
      ...
      AfeFanImpl(int nr, int icon, std::string name, std::string desc, double lam, double turb, double expt, double rdens, double fdf, double sop,
    ...
    class AfeSupImpl
    {
     public:
      ...
      AfeSupImpl(int nr, int icon, std::string name, std::string desc, int sched, int u_H, std::vector<AirflowSubelementData> subelements);
      void read(Reader& reader);
      std::string write();
      void readDetails(Reader& input);
